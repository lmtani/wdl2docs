"""
WDL File Loader - Infrastructure Layer

Responsible for loading WDL files using miniwdl library and reading source code.
"""
...
class WDLLoader:
    ...
    @staticmethod
    def load_wdl_file(wdl_file: Path) -> WDL.Document:
        """
    ...
    @staticmethod
    def load_with_source(wdl_file: Path) -> Tuple[WDL.Document, Optional[str]]:
        """
        ...
        source_code = WDLLoader.read_source_code(wdl_file)
        return doc, source_code

    @staticmethod
    def extract_version(doc: WDL.Document) -> str:
        """
